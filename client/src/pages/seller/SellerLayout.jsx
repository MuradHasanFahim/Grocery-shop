...
import { Link, NavLink, Outlet, useNavigate } from 'react-router';  // <-- import Outlet
    ...
    return (
        <div>
            ...
            <div className="flex">
                ...
                {/* Main content (nested routes go here) */}
                <div className="flex-1 p-4">
                    <Outlet />   {/* <-- This renders AddProduct, ProductList, Orders */}
                </div>
            </div>
        </div>
    );
